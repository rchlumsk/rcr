...
# # update g02 with new xsectionList (add a cross-section)
# g02$xsectionList <- list(xs_4,xs_5,xs_4)
#
# # alternate way to update xsectionList in g02
# g02$field("xsectionList",list(xs_4,xs_5))
#
# g02$xsectionList <- modifyList(g02$xsectionList, list(xs_4))
...
ropt$dx <- 0.05        # change the interpolated horizontal chainage to 5cm, more coarse resolution
